...
> [!TIP]
> **Versión PDF Interactiva:** Si deseas visualizar, hacer zoom o navegar de forma vectorial e interactiva por cada entidad y relación del modelo de datos de Krevo, puedes abrir el archivo directo [base-de-datos.pdf](base-de-datos.pdf).
